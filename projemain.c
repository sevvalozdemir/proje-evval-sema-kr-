...
int main()
{
    ...
    printf("Bu testimize göre size ne kadar anksiyetik olduðunuzu söylüyoruz?\nHazýrsanýz;\nHaydi Teste!!\n");
    printf("NOT: Bu bir eðlence testidir.Konuyla ilgili iþin uzmanýna danýþmanýzý tavsiye ederiz:))\n\n\n");
    printf("Aþaðidaki sorulari evet(1) veya hayir(0) olarak cevaplandiriniz.\n\n");
    int i;
    for ( i = 0; i < 10; i++) {
